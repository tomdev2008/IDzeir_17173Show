package com._17173.flash.player.module.quiz.ui.QuizControlBar
{
	...
	public class QuizUIBottomBarLeftItem extends Sprite
	{
		...
		public function QuizUIBottomBarLeftItem()
		{
			super();
			initTextFormat();
			init();
...
//				_perLine.setData(1);
		...
		private function initLeft():void {
			...
			_betCon = new Sprite();
			_betBtn = new Button();
			_betBtn.setSkin(new quizBetRed());
