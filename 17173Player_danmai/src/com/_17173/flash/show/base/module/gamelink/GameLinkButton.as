...
//			onGetData();
		...
		{
			this.height = _iconsp.height + 2*LEADING;
			_iconsp.x = _iconsp.y = LEADING;
			if(_labelTxt){
				this._labelTxt.x = _iconsp.x + _iconsp.width + LEADING;
				this._labelTxt.y = this.height - this._labelTxt.height>>1;
			}
		}
