package com._17173.flash.show.base.module.userlist
{
	...
	public class UserListDelegate extends BaseModuleDelegate
	{
		...
		private function hidenWarp(value:* = null):void
		{
			...
			if(value!=SEvents.OPEN_USER_LIST)module.data = {"hiden":null};
		}
		...
		override protected function clear():void
		{
			...
			this._e.remove(SEvents.USER_INIT_FROM_SPEAK,addUserFromSpeak);
		...
		private function userListUpdateHandler(value:*):void
		{
			...
			var iUserList:IUserList = this.module as IUserList;
			if(!iUserList.inited)
			{
				Ticker.tick(500,this.showUserList);
			}
		}
