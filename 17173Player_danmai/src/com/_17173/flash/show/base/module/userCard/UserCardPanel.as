package com._17173.flash.show.base.module.userCard
{
	...
	public class UserCardPanel extends BasePanel
	{
		 ...
		 * 基本信息面板. 
		 */		
		private var _infoContainer:UserInfoCard = null;
		/**
		 * 身份信息图标 
		 */		
		...
		public function UserCardPanel()
		{
			...
			this.setSkin_Bg(new UserCardBglayer1_8());
		...
		protected function createCards():void {
			if (_infoContainer == null) {
				_infoContainer = new UserInfoCard();
		...
		private function createLine():Sprite {
			var line:Sprite = new UserCardLine1_8();
			line.x = 1;
