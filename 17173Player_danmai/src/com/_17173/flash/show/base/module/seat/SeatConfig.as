...
//		 *每排座位起点 
//		 */		
//		public static var potConfig:Array = [new Point(146,39),new Point(22,60),new Point(23,102),new Point(24,118)];
		
		/**
		 *每排座位起点 
		 */		
		public static var potConfig:Array = [new Point(22,60),new Point(23,102),new Point(24,138)];
//		/**
//		 *每排座位数量 
//		 */		
//		public static var seatRowCountConfig:Array = [15,21,21,21];
		/**
		 *每排座位数量 
		 */		
		public static var seatRowCountConfig:Array = [21,21,21];
		/**
		 *座位宽度 
		 */		
