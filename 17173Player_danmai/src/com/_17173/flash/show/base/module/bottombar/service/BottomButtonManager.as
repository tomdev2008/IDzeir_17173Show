package com._17173.flash.show.base.module.bottombar.service
{
	...
	import com._17173.flash.show.base.module.bottombar.view.ButtonBindData;
...
//		/**
//		 *默认按钮组 (如按钮数据order不设定，则按照检测顺序返回排列)
//		 * <br> 方法定义格式; 返回值：按钮数据（如果允许显示则返回 否 返回null）
//		 */		
//		private function initDefaultFunctions():void{
//			_checkDefaultFunctions = [checkOpenPublic,checkOpenGiftEff];
//		}
...
//		 * 
//		 */		
//		public function removeCheckFunction(check:Function):void{
//			if(check && _checkFunctions.indexOf(check)>=0){
//				_checkFunctions.slice(_checkFunctions.indexOf(check),1);
//			}
//		}
...
//		 * 
//		 */		
//		public function getInitButtonDatas():Array{
//			return getDefaultButtonDatas();
//		}
		/**
		 *根据用户获取按钮 
		 * @param user
...
//		 * 
//		 */		
//		public function getDefaultButtonDatas():Array{
//			var result:Array = [];
//			result = getButtonByCheckFunctions(_checkDefaultFunctions);
//			return result;
//		}
		/**
		 *通过检测方法获得按钮组 
