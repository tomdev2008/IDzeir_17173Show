package com._17173.flash.show.base.module.topbar.view.messages
{
	 ...
	 * 
	 */	
	public class GlobalMessageSprite extends GlobalMessageBase
	{
		public function GlobalMessageSprite()
		{
			super();
		}
		...
		override protected function setupInfo():void{
			...
			sName = infos.sName;
			tname = infos.tName;
			gName = "<font color='#63D3FF' size='16'> 送给  </font>";
			otCount = "<font color='#FFFF00' size='16'> " + infos.giftCount + " </font>" + "<font color='#63D3FF' size='16'>个" + infos.giftName + "</font>";
