package com._17173.flash.show.base.module.userlist.view
{
	...
	public class UserListTabContainer extends TabContainer
	{
		...
		{
			tabBar = new TabBar(UserListTabButton,Breakline1_8);
		...
		override protected function drawRules():void
		{
			...
			this.graphics.beginFill(0xb00064);
			this.graphics.drawRect(0, tabBar.contentMaxHeight - .5, viewStack.contentMaxWidth-1, 1);

			this.graphics.beginFill(0x4d4d4d);
			this.graphics.drawRect(0, tabBar.contentMaxHeight + .5, viewStack.contentMaxWidth-1, 1);
		}
		...
		{
			super.update();
			viewStack.y=tabBar.contentMaxHeight+1;
		}
	}
}