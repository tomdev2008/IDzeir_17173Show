package com._17173.flash.show.base.context.user
{
	...
	public class UserData implements IUserData
	{
		...
		private var _masterNoFlag:String = "0";
		private var _masterNoSwf:String = "";
		private var _expireSoon:String = "0";
		 ...
		 * 
		 */		
		public function get masterNoFlag():Boolean
		{
			return _masterNoFlag == "1";
		}
		
		public function get masterNoSwf():String
		{
			return _masterNoSwf;
		}
		
		public function get expireSoon():Boolean
		{
			return _expireSoon == "1";
		}
		...
		public function get saler():Boolean
		{
			return this._role.indexOf("5")>=0;
		}
...
//		}
		private function updateData(data:Object):void{
			if (data) {
				...
				_masterNoFlag = p(_masterNoFlag,_sourceData,"masterNoFlag");
				
				_masterNoSwf = p(_masterNoSwf,_sourceData,"masterNoSwf");
				
				_expireSoon = p(_expireSoon,_sourceData,"expireSoon");
