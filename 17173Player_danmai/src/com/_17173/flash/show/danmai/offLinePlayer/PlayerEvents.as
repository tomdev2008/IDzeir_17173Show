package com._17173.flash.show.danmai.offLinePlayer
{
	public class PlayerEvents
	{
		 ...
		 * 视频开始初始化 
		 */		
		public static const BI_VIDEO_INIT:String = "onBIVideoInit";
		/**
		 * 用户登录 
		 */		
		 ...
		 * 站外播放器动态模型解析结束
		 */		
		public static const BI_MODULE_DATA_COMPLETE:String = "onModuleDataComplete";
		/**
		 * 站外播放器数据都已经获取到了 
		 */		
		 ...
		 * 获取视频调度失败
		 */		
		public static const GET_VIDEO_DATA_ERROR:String = "getVideoDataError";
		/////////////////////////////////
		//
		// interactive
		//
