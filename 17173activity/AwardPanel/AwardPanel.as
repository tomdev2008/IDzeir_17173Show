package {
	...
	public class AwardPanel extends MovieClip {
		...
		public function AwardPanel():void {
			//检测舞台
			if (stage) {
				stageInited();
			} else {
		...
		private function init():void {
			 ...
			 */
			lottoButtonProxy.x = 295; lottoButtonProxy.y = 295;
			lottoButtonProxy.graphics.clear();
			lottoButtonProxy.graphics.beginFill(0x000fff,0);
			lottoButtonProxy.graphics.drawRect(0,0,185,185);
