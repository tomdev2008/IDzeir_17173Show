package com._17173.flash.show.base.module.animation.extAnimation
{
	 ...
	 * 
	 */	
	public class CACAnimation extends AnimationObject
	{
		private var _mcX:int = 0;
		private var _mcY:int = 0;
		...
		override public function loadCmp(data:IResourceData):void
		{
			...
			if(data != null && data.source != null){
				_loadFail = false;
				_loaded = true;
				var resouce:ResourceManager = Context.getContext(CEnum.SOURCE) as ResourceManager;
