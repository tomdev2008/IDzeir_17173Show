package com._17173.flash.show.base.module.gameLink
{
	...
	public class GameLinkPanel extends VScrollPanel
	{
		...
		private function initDate():void{
			_datas = [];
			var obj:Object = {label:"四大美女",link:"",icon:new Icon_link1(),jk:"0"};
			var obj1:Object = {label:"水果转转转",link:"",icon:new Icon_link2(),jk:"1"};
			var obj2:Object = {label:"名驹",link:"",icon:new Icon_link3(),jk:"2"};
