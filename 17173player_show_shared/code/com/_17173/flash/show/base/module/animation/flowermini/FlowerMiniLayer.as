package com._17173.flash.show.base.module.animation.flowermini
{
	...
	public class FlowerMiniLayer extends BaseAnimationLayer
	{
		...
		private function initPots():void{
			_pots = [new Point(30,18), new Point(141,18), new Point(26,75), new Point(157,76), new Point(88,133), new Point(220,140),
				 new Point(820,11), new Point(940,11), new Point(816,72), new Point(927,67), new Point(741,138), new Point(859,128)
			];
		}
		/**
		 *添加到静态 
		 ...
		 * 
		 */		
		public function addExtFlow(adata:AnimationObject):void{
			extIndx = randGet();
			if(_isBitmapCeche){
