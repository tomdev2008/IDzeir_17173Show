package com._17173.flash.show.base.module.animation.carmini
{
	...
	public class CarRunway extends BaseModule
	{
		...
		private function addGiftAmt1(obj:Object):void{
		    ...
		    var at:AnimationObject = AnimationObject.getAmd(obj.giftSwfPath1,AnimationType.ATYPE_CAR_MINI,_layer);
//			at = AnimationObject.getAmd("assets/car1.swf",AnimationType.ATYPE_CAR_MINI,_layer);
			at.data = obj;
			addAmdData(at);
		}
		/**
