package com._17173.flash.show.base.module.dingyue
{
	...
	public class DingyuePanel extends BasePanel
	{
		...
		{
			super.onInit();
			titleStr = "<font size='12' color='#757575'>直播订阅提醒</font>";
			initFace();
			initContext();
		}
		...
		private function initContext():void
		{
			...
			_label0.width = 200;
			_label0.height = 20;
			_label0.htmlText = "<font color='#757575'>您订阅的艺人：</font>";
		...
		{
			(Context.getContext(CEnum.SERVICE) as ServiceProvider).http.getData(SEnum.SUB_READ,{subid:_data.masterId},function onOK(data:Object):void{});
		}
