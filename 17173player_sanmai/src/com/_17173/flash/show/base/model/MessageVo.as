package com._17173.flash.show.base.model
{
	...
	public class MessageVo
	{
		...
		private var _giftDyEffect:String = null;
		...
		private var _effectEndType:String = "";
		private var _canSendChat:int = 1;
		private var _price:String = "";
		private var _giftNum:String = "";
		private var _userLvl:String = "";
		private var _userFunLvl:String = "";
		public function MessageVo()
		{
			
		}
		
		public function get userFunLvl():String
		{
			return _userFunLvl;
		}
		
		public function set userFunLvl(value:String):void
		{
			_userFunLvl = value;
		}
		
		public function get userLvl():String
		{
			return _userLvl;
		}
		
		public function set userLvl(value:String):void
		{
			_userLvl = value;
		}
		
		public function get giftNum():String
		{
			return _giftNum;
		}
		
		public function set giftNum(value:String):void
		{
			_giftNum = value;
		}
		...
		public function get effectEndType():String
		{
			return _effectEndType;
		}
		
		public function set effectEndType(value:String):void
		{
			_effectEndType = value;
		}
		
		/**
		 *是否可以发送到聊天区 
		 */
		public function get canSendChat():int
		{
			return _canSendChat;
		}
		 ...
		 * @private
		 */
		public function set canSendChat(value:int):void
		{
			_canSendChat = value;
		}
		...
		public function get giftDyEffect():String
		{
			return _giftDyEffect;
		}
		
		public function set giftDyEffect(value:String):void
		{
			_giftDyEffect = value;
		}
		...
		private function setupMsg(data:Object):void{
			if(data){
				...
				_effectType = p(_effectType,data,"giftEffect");
				_giftDyEffect = p(_effectType,data,"giftDyEffect");
				...
				_canSendChat =  p(_canSendChat,data,"giftSpecialLocation");
				_userLvl =  p(_userLvl,data,"userLevel");
				_userFunLvl =  p(_userLvl,data,"userFanLevel");
			}
		}
