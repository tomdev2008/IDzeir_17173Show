package com._17173.flash.show.base.module.animation.flowermini
{
	...
	public class FlowerMini extends BaseModule
	{
		...
		public function addGiftAmt(obj:Object):void{
			...
			var at:IAnimationPlay = ac.getAmd(obj.giftSwfPath1,AnimationType.ATYPE_FLOWER_MINI,_layer);
//			var at:IAnimationPlay = ac.getAmd("assets/fl1.swf",AnimationType.ATYPE_FLOWER_MINI,_layer);
			at.data = obj;
			addAmdData(at);
		}
		/**
		 ...
		 * 
		 */		
		public function addExtFlow(data:Array):void{
			...
			for (var i:int = 0; i < len; i++) 
			{
				...
				for(var j:int = 0; j< ct ; j++){
					var at:IAnimationPlay = ac.getAmd(msg[i].giftSwfPath1,AnimationType.ATYPE_FLOWER_MINI,_layer);
					at.data = msg[i];
					_bac.addExtData(at);
				}
			}
