		...
		private function updateInfo():void
		{
			...
			if(_user)
			{
				if(_user.isAdmin)
				{
					//巡管
					_hasGraphic = true;
					this.addChild(Utils.getURLGraphic("assets/img/level/admin.png",true));
				}
				if(_user.agent)
				{
					//代理
					_hasGraphic = true;
					this.addChild(Utils.getURLGraphic("assets/img/level/agent.png",true));
				}
				if(_user.broker)
				{
					//房主 经纪人
					_hasGraphic = true;
					this.addChild(Utils.getURLGraphic("assets/img/level/broker.png",true));
				}else if(_user.assistant){
					//副房主 助理
					_hasGraphic = true;
					this.addChild(Utils.getURLGraphic("assets/img/level/assistant.png",true));
				}else if(_user.artist){
					//艺人 主播
					_hasGraphic = true;
					this.addChild(Utils.getURLGraphic("assets/img/level/artist.png",true));
				}else if(_user.normalAdmin){
					//管理员
					_hasGraphic = true;
					this.addChild(Utils.getURLGraphic("assets/img/level/normalAdmin.png",true));
				}
			}
		}
