package com._17173.flash.show.base.module.chat.vo
{
	...
	public class UserLevelUpVo extends BaseChatVo
	{
		...
		private function createPublicElement():void
		{
			...
			//文件扩展名类型
			var iType:String = _level > 25 ? ".swf" : ".png";
			//升级类型
			var uType:String = "";
			if(_type==UP_TYPE_ANCHORS)
			{
				uType = "lv";
			}else{
				uType = "cflv";
			}
			var key:String = "assets/img/level/" + uType + _level + iType;
			var ico:BitmapMovieClip = new BitmapMovieClip();
			ico.url = key;
			ico.y = 3;
