...
//			_bgLayer.x = Context.stage.stageWidth / 2;
//			_bgLayer.y = Context.stage.stageHeight / 2;
		}
		...
		private function centerBackground():void {
			_bgLayer.x = (Context.stage.stageWidth - _bg.width) / 2;
