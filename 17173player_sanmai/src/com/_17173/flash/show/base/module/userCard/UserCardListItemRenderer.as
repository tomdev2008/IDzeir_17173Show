package com._17173.flash.show.base.module.userCard
{
	...
	public class UserCardListItemRenderer extends ListItemRenderer
	{
		...
		{
			super();
			defualtFormat.color = FontUtil.FONT_COLOR_BLUE1;
			defualtFormat.size = 12;
			defualtFormat.bold = false;
			
			selectFormat.color = FontUtil.FONT_COLOR_VIOLET;
...
//			_overBg.width = 158;
			...
			_overBg.graphics.beginFill(0x22033c);
			_overBg.graphics.drawRect(-9,0,this.width + 6,this.height);
